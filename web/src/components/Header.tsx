            ...
            <Dialog.Root>
                ...
                <Dialog.Portal>
                    ...
                    <Dialog.Content className='absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                        <Dialog.Close className='absolute rounded-lg right-6 top-6 text-zinc-400 hover:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-violet-500 focus ring-offset-2 focus:ring-offset-zinc-900'>
